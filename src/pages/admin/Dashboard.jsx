...
const Dashboard = () => {
  const Appbar= <Paper elevation={3} sx={{
    padding: '2rem', margin:'4rem 0', borderRadius: '1rem'}}>
      ...
      <Container component={'main'}>
        ...
        <Stack direction={{ xs:'column',lg:'row'
          ...
          <Paper elevation={3} sx={{
            padding: '2rem 3.5rem', borderRadius: '1rem', width: '100%', maxWidth: '45rem'
          }}>
            <Typography variant={'h5'}>Last Messages</Typography>
             <LineChart value={[23,56,33,67,33,2]}/> 
          </Paper >
          <Paper elevation={3} sx={{
            padding: '1rem', borderRadius: '1rem', width: {xs:'100%', sm:'50%'}, display:'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', width: '100%', maxWidth: '25rem'
          }}>
