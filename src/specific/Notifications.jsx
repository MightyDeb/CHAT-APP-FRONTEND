  ...
  return (
    <Dialog open>
      <Stack p={{xs:'1rem',sm:'2rem'}} maxWidth={'25rem'}>
        ...
        sampleNotifications.map((i)=> <NotificationItem sender={i.sender} _id={i._id} handler={friendRequestHandler}/>): <Typography textAlign={'center'}>0 Notifications</Typography>}
      </Stack>
    </Dialog>
  )
}
